                    ...
                    <div class="card-body">
                        <form id="create-podcast-form" action="{{ route('dashboard.podcasts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="time" name="time" class="form-control @error('time') is-invalid @enderror" placeholder="Örn: 25 dakika 47 saniye" value="{{ old('time') }}" required>
                                @error('time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" id="link" name="link" class="form-control @error('link') is-invalid @enderror" required value="{{ old('link') }}" placeholder="https://example.com/podcast">
                                @error('link')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
