                ...
                <div class="card-body">
                    <form id="edit-podcast-form" action="{{ route('dashboard.podcasts.update', $podcast->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="time" name="time" class="form-control @error('time') is-invalid @enderror" placeholder="Örn: 25 dakika 47 saniye" value="{{ old('time', $podcast->time) }}" required>
                            @error('time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button type="submit" class="btn btn-success rounded-pill px-4">
                                <i class="fas fa-save me-1"></i> Podcast'i Güncelle!
                            </button>
                        </div>
                    </form>
